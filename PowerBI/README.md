...
### Transactions
| TransactionID | CustomerID | ProductID | TransactionDate | Quantity | Price | TotalValue | Proceso ETL
...
Power BI | Power Query | DAX | Modelo Estrella | Microsoft Excel
